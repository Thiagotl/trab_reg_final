...
$$y=\beta_{1}+\beta_{5}x_{5}+\beta_{8}x_{8}+\beta_{9}x_{9}$$
Sendo $\beta{1}$ o intercepto e as covariáveis sqft\_living e yr\_built e waterfront. Com o novo modelo ajustado temos  um $R^{2}$ de 0,633, ou seja, aproximadamente 63\% da variabilidade de y é explicado pelo modelo em questão. 
