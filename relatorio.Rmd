...
# Seleção do modelo
Nesta seção temos a construção do primeiro modelo no qual foi ajustado com todas as variáveis para explicação da variável \textit{price}.

## Variáveis do estudo
Na tabela \ref{tab:tab} temos a análise descritiva das variáveis. Logo, podemos indicar o primeiro modelo ajustado com todas as variáveis: 
...
## Análise de diagnóstico e inflência
